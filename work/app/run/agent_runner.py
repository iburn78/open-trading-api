...
async def agent_runner(logger):
    ...
    A1.initialize(init_cash_allocated=100_000_000, init_holding_qty=0, init_avg_price=170000, sync_start_date='2026-01-30')
    A2.initialize(init_cash_allocated=100_000_000, init_holding_qty=0, init_avg_price=170000, sync_start_date='2026-01-30')
    B1.initialize(init_cash_allocated=100_000_000, init_holding_qty=0, init_avg_price=888000, sync_start_date='2026-01-30')
    B2.initialize(init_cash_allocated=100_000_000, init_holding_qty=0, init_avg_price=888000, sync_start_date='2026-01-30')
